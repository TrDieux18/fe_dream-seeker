                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem >
                              ...
                              <FormControl>
                                 <Input disabled={isSigningUp} placeholder="John Doe" {...field} />
                              </FormControl>
                           </FormItem>
                        )}
                     />
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem >
                              ...
                              <FormControl>
                                 <Input disabled={isSigningUp} placeholder="john.doe@example.com" {...field} />
                              </FormControl>
                           </FormItem>
                        )}
                     />
                     ...
                     <FormField
                        ...
                        render={({ field }) => (
                           <FormItem >
                              ...
                              <FormControl>
                                 <Input disabled={isSigningUp} type="password" placeholder="********" {...field} />
                              </FormControl>
                              <FormMessage />
                           </FormItem>
                        )}
                     ...
                     <FormField
                        ...
                        render={({ field, fieldState }) => (
                           <FormItem >
                              ...
                              {!fieldState.error && (<FormDescription>
